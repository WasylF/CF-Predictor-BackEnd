...
public class AdditionalExecutor {
    ...
    public static void main(String[] args) throws Exception {
        ...
        args = new String[]{"getPastRating", "2000", "1550", "/home/wasylf/Projects/RatingStorage/contests"};
        // args = new String[]{"testRating", "908", "908"}; //592
        // args = new String[]{"matchesIdToNames", "false"};
        args = new String[]{"calcGetNext", "1556", "1556", "/home/wasylf/Projects/RatingStorage/next_rating"};
    ...
    public static void getPastRating(String[] args) {
        if (args.length != 4) {
            throw new IllegalArgumentException("Arguments should have 4 values: getPastRating, max contest id, id of contest from which to load initial rating, path to where rating data is stored.");
        }
    ...
    private static void calcGetNext(String[] args) {
        if (args.length != 4) {
            throw new IllegalArgumentException("Arguments should have 4 values: calcGetNext, min contest id, max contest id, path to where rating changes should be written.");
        }
        int minId = Integer.parseInt(args[1]);
        int maxId = Integer.parseInt(args[2]);
        String path = args[3];
