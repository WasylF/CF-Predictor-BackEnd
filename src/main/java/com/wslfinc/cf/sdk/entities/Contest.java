...
public class Contest implements Comparable<Contest> {
  ...
  /**
   * String. Localized. Can be absent. Human-readable type of the contest from the following categories: Official
   * ACM-ICPC Contest, Official School Contest, Opencup Contest, School/University/City/Region Championship, Training
   * Camp Contest, Official International Personal Contest, Training Contest.
   */
  String kind;

  /**
   * String. Localized. Can be absent. Name of the ICPC Region for official ACM-ICPC contests.
   */
  String icpcRegion;
  ...
  public Contest(int id, String name, ContestType type, ContestPhase phase, boolean frozen, int durationSeconds,
