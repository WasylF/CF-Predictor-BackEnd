...
public class RatingChange {
  ...
  /**
   * Integer. Place of the user in the contest. This field contains user rank on the moment of rating update. If
   * afterwards rank changes (e.g. someone get disqualified), this field will not be update and will contain old rank.
   */
  int rank;
  ...
  public RatingChange(int contestId, String contestName, String handle, int rank, long ratingUpdateTimeSeconds,
