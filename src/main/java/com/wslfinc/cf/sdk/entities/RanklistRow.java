...
public class RanklistRow {
  ...
  /**
   * List of ProblemResult objects. Party results for each problem. Order of the problems is the same as in "problems"
   * field of the returned object.
   */
  List<ProblemResult> problemResults;

  /**
   * Integer. For IOI contests only. Time in seconds from the start of the contest to the last submission that added
   * some points to the total score of the party.
   */
