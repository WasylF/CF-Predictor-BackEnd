...
public class Party {
  ...
  /**
   * String. Localized. Can be absent. If party is a team or ghost, then it is a localized name of the team. Otherwise,
   * it is absent.
   */
  String teamName;

  /**
   * Boolean. If true then this party is a ghost. It participated in the contest, but not on Codeforces. For example,
   * Andrew Stankevich Contests in Gym has ghosts of the participants from Petrozavodsk Training Camp.
   */
  boolean ghost;
  ...
  public Party(int contestId, List<Member> members, ParticipantType participantType, int teamId, String teamName,
      boolean ghost, int room, long startTimeSeconds) {
