...
public class JsonExtractor {
  ...
  /**
   * Extracting String value from JSON object if it exists, otherwise returning empty string
   *
  ...
  /**
   * Extracting int value from JSON object if it exists, otherwise returning {@code NEGATIVE_INFINITY}
   *
   * @param obj  JSON object, could be NULL
   * @param name filed name
   * @return int value
  ...
  /**
   * Extracting long value from JSON object if it exists, otherwise returning {@code NEGATIVE_INFINITY}
   *
   * @param obj  JSON object, could be NULL
   * @param name filed name
   * @return long value
  ...
  /**
   * Extracting boolean value from JSON object if it exists, otherwise returning {@code FALSE}
   *
   * @param obj  JSON object, could be NULL
   * @param name filed name
  ...
  /**
   * Extracting double value from JSON object if it exists, otherwise returning {@code NEGATIVE_INFINITY}
   *
   * @param obj  JSON object, could be NULL
   * @param name filed name
   * @return double value
  ...
  /**
   * Extracting {@code List<Memeber>} value from JSON object if it exists, otherwise returning empty list
   *
  ...
  /**
   * Extracting {@code List<problemResults>} value from JSON object if it exists, otherwise returning empty list
   *
